...
$theme_options[] = array( "name" => __('Footer copyright text',  'wpspace'),
			...
			"std" => "WPSpace &copy; 2016 All Rights Reserved",
			"type" => "textarea");
...
$theme_options[] = array( "name" => __('Google API Key',  'wpspace'),
			"desc" => "Insert Google API Key for browsers into the field above to generate Google Maps",
			"id" => $shortname . '_' . "google_api",
			"std" => "",
			"type" => "text");


$theme_options[] = array( "name" => __("Mail function", 'wpspace'),
